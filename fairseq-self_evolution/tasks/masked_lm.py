...
class MaskedLMTask(LegacyFairseqTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, token_mask=None, **kwargs):
        ...
        src_dataset, tgt_dataset, ref_dataset, tag_dataset  = MaskTokensDataset.apply_mask(
            dataset,
            self.source_dictionary,
            ...
            token_mask=token_mask if split == "train" else None
        )
            ...
            NestedDictionaryDataset(
                {
                    ...
                    "net_input_ref": {
                        ...
                        "src_lengths": NumelDataset(ref_dataset, reduce=False),
                    },
