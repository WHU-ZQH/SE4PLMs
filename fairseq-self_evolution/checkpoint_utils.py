...
def load_checkpoint(cfg: CheckpointConfig, trainer, token_mask=None, **passthrough_args):
    """
    ...
    *passthrough_args* will be passed through to
    ...
    if extra_state is not None and not reset_dataloader:
        ...
        epoch_itr = trainer.get_train_iterator(
            epoch=itr_state["epoch"], load_dataset=True, token_mask=token_mask, **passthrough_args
        )
        epoch_itr.load_state_dict(itr_state)
    else:
        epoch_itr = trainer.get_train_iterator(
            epoch=1, load_dataset=True, token_mask=token_mask, **passthrough_args
        )
