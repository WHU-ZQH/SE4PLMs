...
def distributed_main(i, main, cfg: FairseqConfig, kwargs, token_mask=None):
...
def call_main(cfg: FairseqConfig, main, token_mask=None, **kwargs):
    ...
    if cfg.distributed_training.distributed_init_method is not None:
        ...
        if not cfg.distributed_training.distributed_no_spawn:
            ...
            torch.multiprocessing.spawn(
                fn=distributed_main,
                args=(main, cfg, kwargs, token_mask),
                nprocs=min(
            ...
            distributed_main(cfg.distributed_training.device_id, main, cfg, kwargs, token_mask)
